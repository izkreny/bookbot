from stats import number_of_words_in, characters_occurrence_in, sort_characters_descending
import sys
...
def main():
    ...
    sorted_characters_occurrence = sort_characters_descending(characters_occurrence)
